...
export const caseStudies: CaseStudy[] = [
  {
    ...
    process: [
      ...
      { phase: "Program and Course Design", description: "Created detailed storyboards and oversaw the production of multimedia content to demonstrate advanced surface disinfection and product application.", image: { src: new URL("@/assets/disinfection-course-design.png", import.meta.url).href, alt: "Course design scenario for disinfection training", caption: "Detailed scenarios to practice real-world application." } },
