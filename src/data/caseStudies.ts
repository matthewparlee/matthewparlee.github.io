...
export const caseStudies: CaseStudy[] = [
  {
    ...
    process: [
      ...
      { phase: "Storyboard & Video Design", description: "Created detailed storyboards and oversaw the production of multimedia content to demonstrate advanced surface disinfection and product application.", image: { src: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=80", alt: "Storyboard layout for disinfection module", caption: "Detailed storyboard for multimedia disinfection training content" } },
